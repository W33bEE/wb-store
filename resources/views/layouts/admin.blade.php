...
<head>
    ...
    <title>WB-Admin - HTML5 Admin</title>
    <meta name="description" content="WBAdmin - HTML5 Admin">
        ...
        <div class="header-menu">
            ...
            <div class="col-sm-7 ">
                ...
                <div class="header-left">
                    <button class="search-trigger"><i class="fa fa-search wi"></i></button>
            ...
            <div class="page-header float-right">
                <div class="page-title">
                    <ol class="breadcrumb text-right">
                        <li class="active">@yield('dash','dashboard')</li>
                    </ol>
                </div>
            </div>
        </div>
